...
public class DdsEndpoint_TopicDurabilityServiceMaxInstances_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicDurabilityServiceMaxInstances_Test.class);
   ...
   public void init() throws UnsupportedEncodingException
   {
      ...
      String qos = "?TopicDurabilityServiceMaxInstances=100";
      ...
      final String fromURI = "dds:Chat_SimpleChatMessage_TopicDurabilityServiceMaxInstances:0/Chat.SimpleChatMessage"
