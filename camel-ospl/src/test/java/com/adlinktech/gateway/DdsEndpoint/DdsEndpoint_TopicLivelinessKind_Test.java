...
public class DdsEndpoint_TopicLivelinessKind_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicLivelinessKind_Test.class);
   ...
   public void init() throws UnsupportedEncodingException
   {
      ...
      String qos = "?TopicLivelinessKind=AUTOMATIC";
      ...
      final String fromURI = "dds:Chat_SimpleChatMessage_TopicLivelinessKind:0/Chat.SimpleChatMessage"
