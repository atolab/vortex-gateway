...
/**
 * This class is a trick to run "ospl stop" after all other unit tests.
 ...
 */
public class ZZZ_OsplStop_AfterTest
{


   @Test
   public void doOsplStop()
   {
      System.out.println("==== ospl stop ====");

      ProcessBuilder pb = new ProcessBuilder("ospl", "stop");
