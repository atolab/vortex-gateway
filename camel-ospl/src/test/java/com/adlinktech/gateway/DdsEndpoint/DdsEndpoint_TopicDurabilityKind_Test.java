...
public class DdsEndpoint_TopicDurabilityKind_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicDurabilityKind_Test.class);
   ...
   public void init() throws UnsupportedEncodingException
   {
      ...
      String qos = "?TopicDurabilityKind=PERSISTENT";
      ...
      final String fromURI = "dds:Chat_SimpleChatMessage_TopicDurabilityKind:0/Chat.SimpleChatMessage"
