...
public class DdsEndpoint_TopicDurabilityServiceCleanupDelay_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicDurabilityServiceCleanupDelay_Test.class);
   ...
   public void init() throws UnsupportedEncodingException
   {
      ...
      delay.sec = 100;
      String qos = "?TopicDurabilityServiceCleanupDelay=100";
      ...
      final String fromURI = "dds:Chat_SimpleChatMessage_TopicDurabilityServiceCleanupDelay:0/Chat.SimpleChatMessage"
