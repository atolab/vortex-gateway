...
public class DdsEndpoint_TopicDestinationOrder_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicDestinationOrder_Test.class);
   ...
   public void init() throws UnsupportedEncodingException
   {
      ...
      String qos = "?TopicDestinationOrder=BY_RECEPTION_TIMESTAMP";
      ...
      final String fromURI = "dds:Chat_SimpleChatMessage_TopicDestinationOrder:0/Chat.SimpleChatMessage"
