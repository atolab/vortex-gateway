...
public class DdsEndpoint_TopicDurabilityServiceMaxSamplesPerInstances_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicDurabilityServiceMaxSamplesPerInstances_Test.class);
