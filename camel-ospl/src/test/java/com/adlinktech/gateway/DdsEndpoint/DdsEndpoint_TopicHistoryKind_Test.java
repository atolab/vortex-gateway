...
public class DdsEndpoint_TopicHistoryKind_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicHistoryKind_Test.class);
   ...
   public void init() throws UnsupportedEncodingException
   {
      ...
      final String fromURI = "dds:Chat_SimpleChatMessage_TopicHistoryKind:0/Chat.SimpleChatMessage"
