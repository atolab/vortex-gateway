...
public class DdsEndpoint_TopicDurabilityServiceMaxSamples_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicDurabilityServiceMaxSamples_Test.class);
   ...
   public void init() throws UnsupportedEncodingException
   {
      ...
      String qos = "?TopicDurabilityServiceMaxSamples=100";
      ...
      final String fromURI = "dds:Chat_SimpleChatMessage_TopicDurabilityServiceMaxSamples:0/Chat.SimpleChatMessage"
