...
public class DdsConsumer_BridgeErrorHandler_Test
{

   private static final String DIRECT = "direct:sendMsg";
   private static final String DDS_URI =
         "dds:Chat_SimpleChatMessage:0/Chat.SimpleChatMessage?ignoreLocalPublishers=false&consumer.bridgeErrorHandler=true";
   ...
   private Throwable exceptionOnRead = null;
               ...
               from(DDS_URI)
                     ...
                     .process(new Processor()
                     {
                        ...
                        public void process(Exchange exchange) throws Exception
                        {
                           ...
                           exceptionOnRead = exchange.getProperty(Exchange.EXCEPTION_CAUGHT,
                                 Throwable.class);
                        }
                     })
                     .stop()
   ...
   public void testExceptionOnRead()
   {
      try
      {
         ...
         // reset receivedData and receivedSampleInfo
         receivedData = null;
         receivedSampleInfo = null;
