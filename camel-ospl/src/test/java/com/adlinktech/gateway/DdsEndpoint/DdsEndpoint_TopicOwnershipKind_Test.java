...
public class DdsEndpoint_TopicOwnershipKind_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicOwnershipKind_Test.class);
   ...
   public void init() throws UnsupportedEncodingException
   {
      ...
      String qos = "?TopicOwnershipKind=SHARED";
      ...
      final String fromURI = "dds:Chat_SimpleChatMessage_TopicOwnershipKind:0/Chat.SimpleChatMessage"
