...
public class DdsEndpoint_TopicDurabilityServiceKind_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicDurabilityServiceKind_Test.class);
   ...
   public void init() throws UnsupportedEncodingException
   {
      ...
      String qos = "?TopicDurabilityServiceKind=KEEP_ALL";
      ...
      final String fromURI = "dds:Chat_SimpleChatMessage_TopicDurabilityServiceKind:0/Chat.SimpleChatMessage"
