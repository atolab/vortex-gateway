...
public class DdsEndpoint_TopicDeadlinePeriod_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_TopicDeadlinePeriod_Test.class);
   ...
   public void init() throws UnsupportedEncodingException
   {
      ...
      String qos = "?TopicDeadlinePeriod=2.000000005";
      ...
      final String fromURI = "dds:Chat_SimpleChatMessage_TopicDeadlinePeriod:0/Chat.SimpleChatMessage"
