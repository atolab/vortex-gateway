...
public class DdsEndpoint_LifespanDuration_Test
{
   ...
   private static final Logger logger = LoggerFactory
         .getLogger(DdsEndpoint_LifespanDuration_Test.class);
   ...
   public void testExample() throws IOException
   {
      ...
      // Check if LifespanDuration is well set in the Writer
      try
      {
         ...
         logger.info("Check if LifespanDuration is well set in the Writer");
         // Check if LifespanDuration nanosec is well set in the Writer
         Assert.assertTrue("LifespanDuration nanosec is not well set in the writer ",
               writerHolder.value.lifespan.duration.nanosec == period.nanosec);
         // Check if LifespanDuration sec is well set in the Writer
         Assert.assertTrue("LifespanDuration sec is not well set in the writer ",
               writerHolder.value.lifespan.duration.sec == period.sec);
      ...
      // Check if LifespanDuration is well set in the LifespanDuration attribute
      try
      {
         logger.info("Check if LifespanDuration is well set in the ddsEnpoint attribute");
         // Check if LifespanDuration is well set in in the ddsEnpoint attribute
         Assert.assertTrue("LifespanDuration is not well set in in the ddsEnpoint attribute ",
               ddsEndpoint.getLifespanDuration() == 2.000000005);
