...
public class ContentBasedRoute {
        ...
        try {
            ...
            ctx.addRoutes( new RouteBuilder() {
                ...
                public void configure() throws Exception {
                    ...
                    /*
                     * A route content-based routing, forwarding:
                     *  - blue circles to Square topic
                     *  - red circles to Triangle topic
                     *  - logging a message on stdout for other colors
                     */
                    from("dds:Circle:0/ShapeType"+QOS_OPTIONS)
                    .choice()
                        .when().groovy("request.body.color=='BLUE'")
                            .to("dds:Square:0/ShapeType"+QOS_OPTIONS)
                        .when().groovy("request.body.color=='RED'")
