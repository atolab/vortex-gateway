...
public class FilterRoute {
    ...
    /*
     * Inner class for filtering route
     */
    public static class ShapeFilter {
        public boolean check(ShapeType s) {
            return s.x > 100;
        }
    }
        ...
        try {
            ...
            ctx.addRoutes( new RouteBuilder() {
                ...
                public void configure() throws Exception {
                    ...
                    /*
                     * A filtered route forwarding only shapes
                     * with X coordinate > 100
                     * (using class ShapeFilter as a bean)
                     */
                    from("dds:Circle:0/ShapeType"+QOS_OPTIONS)
                    .filter().method(ShapeFilter.class, "check")
